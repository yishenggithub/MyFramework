...
<head>
    ...
    <script type="<%=basePath%>application/javascript">
                        ...
                        success: function (data) {
                            if (data["result"] == "SUCCESS") {
                                ...
                                ('<li class="dropdown"><a data-toggle="dropdown" class="dropdown-toggle"' +
                                    ...
                                    '<a href="logout?uid='+uid_+' " class="logout-button"><i class="fa fa-sign-out" aria-hidden="true"></i> ' +
                                    '注销</a></li></ul></li>');
                                $("#myDiv").load("<%=basePath%>articleList?uid=" + uid_);
                            } else {
